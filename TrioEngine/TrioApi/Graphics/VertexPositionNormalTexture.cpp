...
namespace Vago
{
	VertexDeclaration* VertexPositionNormalTexture::g_pVertexDeclaration = nullptr;
...
#endif
			VertexDeclarationHelper::AddVertexDeclaration(typeid(VertexPositionNormalTexture).name(), g_pVertexDeclaration);
		}
