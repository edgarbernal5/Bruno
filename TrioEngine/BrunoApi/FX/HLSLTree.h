...
namespace TrioFX
{
	...
	enum BRUNO_API_EXPORT HLSLNodeType
	{
		HLSLNodeType_Root,
	...
	enum BRUNO_API_EXPORT HLSLTypeDimension
	{
	...
	enum BRUNO_API_EXPORT HLSLBaseType
	{
	...
	enum BRUNO_API_EXPORT HLSLBinaryOp
	{
		HLSLBinaryOp_And,
		HLSLBinaryOp_Or,
		HLSLBinaryOp_Add,
	...
	enum BRUNO_API_EXPORT HLSLUnaryOp
	{
	...
	enum BRUNO_API_EXPORT HLSLArgumentModifier
	{
	...
	enum BRUNO_API_EXPORT HLSLTypeFlags
	{
		HLSLTypeFlag_None = 0,
	...
	enum BRUNO_API_EXPORT HLSLAttributeType
	{
	...
	enum BRUNO_API_EXPORT HLSLAddressSpace
	{
	...
	struct BRUNO_API_EXPORT HLSLNode
	{
	...
	struct BRUNO_API_EXPORT HLSLRoot : public HLSLNode
	{
	...
	struct BRUNO_API_EXPORT HLSLStatement : public HLSLNode
	{
		HLSLStatement()
		{
	...
	struct BRUNO_API_EXPORT HLSLAttribute : public HLSLNode
	{
	...
	struct BRUNO_API_EXPORT HLSLDeclaration : public HLSLStatement
	{
	...
	struct BRUNO_API_EXPORT HLSLStruct : public HLSLStatement
	{
	...
	struct BRUNO_API_EXPORT HLSLStructField : public HLSLNode
	{
	...
	struct BRUNO_API_EXPORT HLSLBuffer : public HLSLStatement
	{
	...
	//struct BRUNO_API_EXPORT HLSLBufferField : public HLSLNode
	//{
	...
	struct BRUNO_API_EXPORT HLSLFunction : public HLSLStatement
	{
	...
	struct BRUNO_API_EXPORT HLSLArgument : public HLSLNode
	{
	...
	struct BRUNO_API_EXPORT HLSLExpressionStatement : public HLSLStatement
	{
	...
	struct BRUNO_API_EXPORT HLSLReturnStatement : public HLSLStatement
	{
	...
	struct BRUNO_API_EXPORT HLSLDiscardStatement : public HLSLStatement
	{
		static const HLSLNodeType s_type = HLSLNodeType_DiscardStatement;
	};

	struct BRUNO_API_EXPORT HLSLBreakStatement : public HLSLStatement
	{
		static const HLSLNodeType s_type = HLSLNodeType_BreakStatement;
	};

	struct BRUNO_API_EXPORT HLSLContinueStatement : public HLSLStatement
	{
		static const HLSLNodeType s_type = HLSLNodeType_ContinueStatement;
	};

	struct BRUNO_API_EXPORT HLSLIfStatement : public HLSLStatement
	{
	...
	struct BRUNO_API_EXPORT HLSLForStatement : public HLSLStatement
	{
	...
	struct BRUNO_API_EXPORT HLSLBlockStatement : public HLSLStatement
	{
	...
	struct BRUNO_API_EXPORT HLSLExpression : public HLSLNode
	{
	...
	struct BRUNO_API_EXPORT HLSLUnaryExpression : public HLSLExpression
	{
	...
	struct BRUNO_API_EXPORT HLSLBinaryExpression : public HLSLExpression
	{
	...
	/** ? : construct */
	struct BRUNO_API_EXPORT HLSLConditionalExpression : public HLSLExpression
	{
	...
	struct BRUNO_API_EXPORT HLSLCastingExpression : public HLSLExpression
	{
	...
	struct BRUNO_API_EXPORT HLSLLiteralExpression : public HLSLExpression
	{
	...
	struct BRUNO_API_EXPORT HLSLIdentifierExpression : public HLSLExpression
	{
	...
	/** float2(1, 2) */
	struct BRUNO_API_EXPORT HLSLConstructorExpression : public HLSLExpression
	{
	...
	/** object.member **/
	struct BRUNO_API_EXPORT HLSLMemberAccess : public HLSLExpression
	{
	...
	/** array[index] **/
	struct BRUNO_API_EXPORT HLSLArrayAccess : public HLSLExpression
	{
	...
	struct BRUNO_API_EXPORT HLSLFunctionCall : public HLSLExpression
	{
	...
	struct BRUNO_API_EXPORT HLSLFunctionAccess : public HLSLFunctionCall
	{
	...
	struct BRUNO_API_EXPORT HLSLStateAssignment : public HLSLNode
	{
	...
	struct BRUNO_API_EXPORT HLSLSamplerState : public HLSLExpression // @@ Does this need to be an expression? Does it have a type? I guess type is useful.
	{
	...
	struct BRUNO_API_EXPORT HLSLPass : public HLSLNode
	{
	...
	struct BRUNO_API_EXPORT HLSLPassShader : public HLSLNode
	{
	...
	struct BRUNO_API_EXPORT HLSLPass11 : public HLSLNode
	{
	...
	struct BRUNO_API_EXPORT HLSLTechnique : public HLSLStatement
	{
	...
	struct BRUNO_API_EXPORT HLSLTechnique11 : public HLSLStatement
	{
	...
	struct BRUNO_API_EXPORT HLSLCompilerShader : public HLSLNode
	{
	...
	struct BRUNO_API_EXPORT HLSLPipeline : public HLSLStatement
	{
	...
	struct BRUNO_API_EXPORT HLSLStage : public HLSLStatement
	{
	...
	*/
	class BRUNO_API_EXPORT HLSLTree
	{
	...
	class BRUNO_API_EXPORT HLSLTreeVisitor
	{
	public:
