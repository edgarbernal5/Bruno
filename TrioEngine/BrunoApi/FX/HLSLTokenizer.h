...
namespace BrunoFX
{
	...
	enum HLSLToken
	{
		...
		// Effect keywords.
		HLSLToken_sampler_state, //"sampler_state"
		HLSLToken_Technique,
		HLSLToken_Pass,
		HLSLToken_Technique11,
		HLSLToken_SetVertexShader,
		HLSLToken_SetPixelShader,
		HLSLToken_SetGeometryShader,
		HLSLToken_CompileShader,
