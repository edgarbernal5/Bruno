...
namespace CuadoFX
{
	...
	*/
	...
	void HLSLTree::PopulateEffectCollections(HLSLTree* root, vector<HLSLTechnique11*> &techniques, vector<HLSLBuffer*> &buffers, vector<HLSLStruct*> &structures)
	{
		HLSLStatement* statement = m_root->statement;
		while (statement != nullptr)
		{
