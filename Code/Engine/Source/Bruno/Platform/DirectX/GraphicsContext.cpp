...
namespace Bruno
{
	...
	void GraphicsContext::SetPipeline(const PipelineInfo& pipelineBinding, bool bindRenderTargets)
	{
		...
		if (bindRenderTargets && m_currentPipeline->m_pipelineType == PipelineType::Graphics)
		{
