...
{
    constexpr float ConvertToRadians(float fDegrees) noexcept { return fDegrees * (DirectX::XM_PI / 180.0f); }
    constexpr float ConvertToDegrees(float fRadians) noexcept { return fRadians * (180.0f / DirectX::XM_PI); }
    ...
    struct Matrix : public DirectX::XMFLOAT4X4
    {
        ...
        Matrix(const DirectX::XMFLOAT4X4& M) noexcept { memcpy(this, &M, sizeof(DirectX::XMFLOAT4X4)); }
...
namespace std
{
    template<> struct less<Bruno::Math::Rectangle>
    {
        bool operator()(const Bruno::Math::Rectangle& r1, const Bruno::Math::Rectangle& r2) const noexcept
        {
            return ((r1.x < r2.x)
                || ((r1.x == r2.x) && (r1.y < r2.y))
    ...
    template<> struct less<Bruno::Math::Vector2>
    {
        bool operator()(const Bruno::Math::Vector2& V1, const Bruno::Math::Vector2& V2) const noexcept
        {
            return ((V1.x < V2.x) || ((V1.x == V2.x) && (V1.y < V2.y)));
        }
    };

    template<> struct less<Bruno::Math::Vector3>
    {
        bool operator()(const Bruno::Math::Vector3& V1, const Bruno::Math::Vector3& V2) const noexcept
        {
            return ((V1.x < V2.x)
                || ((V1.x == V2.x) && (V1.y < V2.y))
    ...
    template<> struct less<Bruno::Math::Vector4>
    {
        bool operator()(const Bruno::Math::Vector4& V1, const Bruno::Math::Vector4& V2) const noexcept
        {
            return ((V1.x < V2.x)
                || ((V1.x == V2.x) && (V1.y < V2.y))
                || ((V1.x == V2.x) && (V1.y == V2.y) && (V1.z < V2.z))
    ...
    template<> struct less<Bruno::Math::Matrix>
    {
        bool operator()(const Bruno::Math::Matrix& M1, const Bruno::Math::Matrix& M2) const noexcept
        {
    ...
    template<> struct less<Bruno::Math::Plane>
    {
        bool operator()(const Bruno::Math::Plane& P1, const Bruno::Math::Plane& P2) const noexcept
        {
            return ((P1.x < P2.x)
                || ((P1.x == P2.x) && (P1.y < P2.y))
    ...
    template<> struct less<Bruno::Math::Quaternion>
    {
        bool operator()(const Bruno::Math::Quaternion& Q1, const Bruno::Math::Quaternion& Q2) const noexcept
        {
            return ((Q1.x < Q2.x)
                || ((Q1.x == Q2.x) && (Q1.y < Q2.y))
    ...
    template<> struct less<Bruno::Math::Color>
    {
        bool operator()(const Bruno::Math::Color& C1, const Bruno::Math::Color& C2) const noexcept
        {
            return ((C1.x < C2.x)
                || ((C1.x == C2.x) && (C1.y < C2.y))
    ...
    template<> struct less<Bruno::Math::Ray>
    {
        bool operator()(const Bruno::Math::Ray& R1, const Bruno::Math::Ray& R2) const noexcept
        {
    ...
    template<> struct less<Bruno::Math::Viewport>
    {
        bool operator()(const Bruno::Math::Viewport& vp1, const Bruno::Math::Viewport& vp2) const noexcept
        {
